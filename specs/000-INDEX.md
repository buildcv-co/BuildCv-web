...
| 009 | `auth-web` | v1 | 🚧 **EN CURSO** (api PR0 MERGED ✅ + web PR1 MERGED ✅ + web PR2 MERGED ✅ + web PR4 MERGED ✅ + web PR6a MERGED ✅ + web PR6b MERGED ✅; web PR3+PR5+PR7+PR8 pending). **Art. IX Habeas Data MVP_BLOCKER CLOSED ✅**. MVP launch path: PR7 (UserMenu) → PR8 (a11y + OpenAPI CI) → PR0 hardening 3 items. | (n/a) |
