...
| 009 | `auth-web` | v1 | 🚧 **EN CURSO** (api PR0 MERGED ✅ + api PR0 hardening MERGED ✅ + web PR1 MERGED ✅ + web PR2 MERGED ✅ + web PR4 MERGED ✅ + web PR6a MERGED ✅ + web PR6b MERGED ✅ + web PR7 MERGED ✅; web PR3+PR5+PR8 pending). **Art. IX Habeas Data MVP_BLOCKER CLOSED ✅**. MVP launch path: PR8 (e2e + a11y + OpenAPI CI) → sdd-verify → sdd-archive → tag final. | (n/a) |
