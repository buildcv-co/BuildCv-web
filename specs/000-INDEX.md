...
| 009 | `auth-web` | v1 | 🚧 **EN CURSO** (api PR0 MERGED ✅ + web PR1 MERGED ✅ + web PR2 MERGED ✅ + web PR4 MERGED ✅ + web PR6a MERGED ✅; web PR6b pending + PR3+PR5+PR7+PR8). MVP launch path: PR6b next (UI panel + modal, SIZE_DEVIATION pending review) → PR7 → PR8. | (n/a) |
