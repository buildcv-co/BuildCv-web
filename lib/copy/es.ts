...
export const copy = {
  ...
  analyze: {
    ...
    llmFeedback: {
      ariaLabel: "AI Feedback",
      title: "Feedback IA",
      disclaimer: "Sugerencias IA complementarias, no reemplazan análisis determinista.",
      cta: "Obtener feedback IA",
      toggleOff: "Desactivar feedback IA",
      toggleOn: "Activar feedback IA",
      disabledTitle: "Feedback IA desactivado",
      disabledSession: "Feedback IA desactivado para esta sesión",
      disabledBody: "El análisis determinista sigue disponible sin cambios.",
      idleBody: "Solicita una lectura complementaria con el proveedor local fake.",
      loading: "Generando feedback IA…",
      complete: "Feedback completo",
      degraded: "Feedback IA degradado",
      unavailable: "Feedback IA no disponible",
      timeout: "Feedback IA tardó demasiado",
      rateLimited: "Demasiadas solicitudes de feedback IA",
      retryAfter: (seconds: string) => `Espera ${seconds} segundos antes de reintentar.`,
      labels: {
        summary: "Resumen",
        strengths: "Fortalezas",
        risks: "Riesgos",
        suggestions: "Sugerencias",
        missingKeywords: "Palabras faltantes",
        questions: "Preguntas para revisar",
        metadata: "Proveedor",
      },
      empty: {
        strengths: "Sin fortalezas reportadas.",
        risks: "Sin riesgos reportados.",
        suggestions: "Sin sugerencias reportadas.",
        missingKeywords: "Sin palabras faltantes reportadas.",
        questions: "Sin preguntas reportadas.",
      },
    },
  },
  result: {
